  ...
  return (
    <PageContainer>
      ...
      <div
        ...
        <div className="flex md:space-x-4 space-x-0 md:w-[120%] w-full flex-col md:flex-row">
      ...
      <div
        ...
        <div className="absolute w-[70%] h-[70%] bg-opacity-[65%] bg-slate-950"></div>
        <div
          className="absolute w-[62%] h-[50%] bg-opacity-60 bg-black"
          style={{
            opacity: 1,
          }}>
          <div className="grid grid-cols-2 grid-rows-2 h-full w-full gap-8 p-8">
            <div className="bg-white opacity-80 p-2 sm:p-3 md:p-4 lg:p-5 flex items-center justify-center">
              <div
                className="bg-white text-black p-2 sm:p-2 md:p-3 lg:p-3 rounded-lg flex items-center cursor-pointer hover:bg-gray-400"
                onClick={() =>
                  handleLinkClick(
            ...
            <div className="bg-white opacity-80 p-4 flex flex-col items-center justify-center">
              <a href="mailto:vietdung56dd@gmail.com">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="rgb(245 158 11)"
            ...
            <div className="bg-white opacity-80 p-4 flex flex-col items-center justify-center">
              <a
                ...
                className="hover:bg-gray-400 p-2 rounded-full flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className=" w-16 h-16 sm:w-12 sm:h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 text-current cursor-pointer"
                  viewBox="0 0 16 16">
                  <path
                    fillRule="evenodd"
              ...
              <p className="mt-2 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-center">
                +1 (518) 986-1012
              </p>
            </div>
          </div>
